...
int wc_HpkeDeserializePublicKey(Hpke* hpke, void** key, const byte* in, word16 inSz)
{
    int ret = 0;
...
static int wc_HpkeDecap(Hpke* hpke, void* receiverKey, const byte* pubKey, word16 pubKeySz,
    byte* sharedSecret)
{
    int ret;
    word32 dh_len;
